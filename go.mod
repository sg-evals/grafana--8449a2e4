...
require (
	buf.build/gen/go/parca-dev/parca/connectrpc/go v1.19.1-20260206050007-a47b093e4fe5.2 // @grafana/observability-traces-and-profiling
	buf.build/gen/go/parca-dev/parca/protocolbuffers/go v1.36.10-20260206050007-a47b093e4fe5.1 // @grafana/observability-traces-and-profiling
